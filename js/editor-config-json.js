...
function getAddConfig($configGroupKey,$config_group_count)
    ...
    html = html + '<tr>';
    html = html + '<td align="center" style="background-color:#FFF;" colspan="2"><input type="button" name="addAPIButton" value="Add This Property" onclick="addNewConfig(); return false;" /></td>';
    html = html + '</tr>'     
