...
function viewedit()
	{
	console.write("here: " + document.getElementById("jsonViewer").style.display);	
...
function getHeader(name,description,url,image,apijsonurl)
    ...
    html = html + '<a href="#" onclick="viewedit(); return false;" id="apis-json-icon" title="APIs.json"><img src="https://s3.amazonaws.com/kinlane-productions/api-commons/api-commons-icon.png" width="50" align="right" /></a>';
