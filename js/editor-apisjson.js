...
function getAPIListing(name,url,description,url)
    ...
    html = html + '<a href="#" onclick="showme(this); return false;" id="add-' + $thisslug + '-icon"><img src="https://s3.amazonaws.com/kinlane-productions/bw-icons/bw-add-circle.png" width="35" align="right"  /></a>';
    html = html + '</span>';
