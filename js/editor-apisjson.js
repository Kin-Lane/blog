...
function getAPIListing(name,url,description,url)
    ...
    html = html + '<a href="#" onclick="showme(this);" id="edit-' + $thisslug + '-icon"><img src="https://s3.amazonaws.com/kinlane-productions/bw-icons/bw-edit-circle.png" width="35" align="right"  /></a>';
    html = html + '<a href="#" onclick="showme(this);" id="add-' + $thisslug + '-icon"><img src="https://s3.amazonaws.com/kinlane-productions/bw-icons/bw-add-circle.png" width="35" align="right"  /></a>';
    html = html + '</span>';
