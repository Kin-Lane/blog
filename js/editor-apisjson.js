...
function getAPITitle(title)
	...
	html = html + '<a href="#" onclick="showme(this);" id="add-api-listing-icon"><img src="https://s3.amazonaws.com/kinlane-productions/bw-icons/bw-add-circle.png" width="35" align="right"  /></a>';
	html = html + '</span>';
	html = html + '</td>';
	html = html + '</tr>';
	return html; 			
...
function getHeader(name,description,url,image,apijsonurl)
    ...
    html = html + '<a href="#" onclick="showme(this);" id="edit-header-icon"><img src="https://s3.amazonaws.com/kinlane-productions/bw-icons/bw-edit-circle.png" width="35" align="right"  /></a>';
